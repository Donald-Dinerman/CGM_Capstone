...
gran_df <- raw_data %>%
  dplyr::select(TAR_prop_1h, respid, spring, tbh1female, datetime_ema, 
                negative_emotion = frconfl, positive_emotion = frsupp, self_care = dmwell, 
...
```{r}
# Drop all NA
gran_mod <- lmer(TAR_prop_1h ~ (1 | respid) + time + week + spring + gender + positive_emotion + negative_emotion + 
...
mod_1hr <- lmer(TAR_prop_1h ~ (1 | respid) + time + week + spring + gender + positive_emotion + negative_emotion + 
                    self_care + anxiety + happiness + depression + atease + eat + exercise,
                    data = completeData)
...
fit_1hr <- with(data = imputed_Data, 
            exp = lmer(TAR_prop_1h ~ (1 | respid) + time + week + spring + gender + positive_emotion + negative_emotion + 
                         self_care + anxiety + happiness + depression + atease + eat + exercise))
...
lag_1hr_mod <- lmer(TAR_prop_1h ~ (1 | respid) + TAR_1hr_lagged + time + week + spring + gender + positive_emotion + negative_emotion + 
                  self_care + anxiety + happiness + depression + atease + eat + exercise,
                data = lagged_df)
...
```{r}
# Imputation Modeling
mod_2hr <- lmer(TAR_prop_2h ~ (1 | respid) + time + week + spring + gender + positive_emotion + negative_emotion + 
                    self_care + anxiety + happiness + depression + atease + eat + exercise,
...
fit_2hr <- with(data = imputed_Data_2hr, 
            exp = lmer(TAR_prop_2h ~ (1 | respid) + time + week + spring + gender + positive_emotion + negative_emotion + 
                         self_care + anxiety + happiness + depression + atease + eat + exercise))
...
lag_2hr_mod <- lmer(TAR_prop_2h ~ (1 | respid) + TAR_2hr_lagged + time + week + spring + gender + positive_emotion + negative_emotion + 
                  self_care + anxiety + happiness + depression + atease + eat + exercise,
                data = lagged_2hr_df)
