...
logistic_gran_2hr_df <- raw_data %>%
  dplyr::select(TAR_bin_2h, respid, spring, tbh1female, weekend, mod_pump,
                negative_interaction = frconfl, positive_interaction = frsupp, self_care = dmwell, 
                anxiety, happiness, depression = depr, atease, eat, exercise = exer
                ) %>%
  mutate(
...
# Do the simulation comparison to estimate the effect of non normal residuals on the estimates
# Ask more about the residuals
```
