...
logistic_2hr_df <- logistic_completeData_2hr %>%
...
```{r}
# Fit Mixed Model
lag_2hr_mm_logistic <- glmer(TAR_bin_2h ~ (1 | respid) + TAR_bin_2h_lagged + time + week + spring + gender + pump + interaction +
                               I(interaction*positive_interaction) + I(interaction*negative_interaction) + self_care + anxiety + happiness + depression + 
                               atease + eat + exercise,
  ...
  rename(., se = Std..Error, p_val = Pr...z..) %>%
    mutate(Significant = ifelse(p_val < 0.05, 1, 0),
         ...
         var_name = case_when(
           ...
           var_name == "pump1" ~ "Pump",
           var_name == "positive_interaction" ~ "Positive Interaction",
           var_name == "self_care" ~ "Self Care",
           var_name == "atease" ~ "At Ease",
           var_name == "I(interaction*positive_interaction)" ~ "Positive Interaction",
           var_name == "I(interaction*negative_interaction)" ~ "Negative Interaction",
